...
insert into sale_part_3cols(sale_id, sale_date, sale_date_year, sale_date_month, region_id, customer_id) values (1, date'2020-01-01', 2020, 1, 'CA', 1);
insert into sale_part_3cols(sale_id, sale_date, sale_date_year, sale_date_month, region_id, customer_id) values (2, date'2021-02-01', 2021, 2, 'CA', 1);
insert into sale_part_3cols(sale_id, sale_date, sale_date_year, sale_date_month, region_id, customer_id) values (3, date'2021-03-01', 2021, 3, 'CA', 1);
insert into sale_part_3cols(sale_id, sale_date, sale_date_year, sale_date_month, region_id, customer_id) values (4, date'2021-05-01', 2021, 5, 'NY', 1);
insert into sale_part_3cols(sale_id, sale_date, sale_date_year, sale_date_month, region_id, customer_id) values (5, date'2021-06-01', 2021, 6, 'NY', 1);
commit;
...
select * from sale_part_3cols partition (p_less_2021);
