...
-- вставка данных
insert into sale_interval_list values (1, date '2023-01-01', 'CA', 100); -- 1
insert into sale_interval_list values (2, date '2004-01-01', 'WA', 101); -- 2
insert into sale_interval_list values (3, date '2023-02-01', 'TX', 102); -- 3
insert into sale_interval_list values (4, date '2023-02-01', 'NY', 103); -- 4
commit;
...
select sysdate, t.* from user_tab_partitions t where t.table_name = 'SALE_INTERVAL_LIST';
...
-- строки 3 и 4
select * from sale_interval_list partition (SYS_P602);
select * from sale_interval_list subpartition (SYS_SUBP599);
select * from sale_interval_list subpartition (SYS_SUBP601);
